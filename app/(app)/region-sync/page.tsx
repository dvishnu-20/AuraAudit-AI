    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">Active-active Aurora DSQL write topology with globally consistent compliance state.</p>
        </div>
      </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              <h3 className="text-sm font-semibold text-white">Why Aurora DSQL Matters</h3>
